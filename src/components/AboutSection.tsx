  ...
  return (
    <section id="about" className="py-16 sm:py-20 lg:py-24 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center mt-8 sm:mt-10 lg:mt-12">
          ...
          <div className="bg-gradient-to-br from-primary/10 to-secondary/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-primary/20 space-y-4 sm:space-y-6">
            <div className="bg-black/50 p-5 sm:p-6 lg:p-8 rounded-xl border-l-4 border-primary backdrop-blur">
              <h3 className="text-primary text-xl sm:text-2xl mb-2 font-semibold">🎯 Our Vision</h3>
            ...
            <div className="bg-black/50 p-5 sm:p-6 lg:p-8 rounded-xl border-l-4 border-primary backdrop-blur">
              <h3 className="text-primary text-xl sm:text-2xl mb-2 font-semibold">💡 Our Mission</h3>
              <p className="text-foreground/70 text-sm sm:text-base">
                Empower students with real-world skills through immersive internships, expert mentorship, and industry-relevant projects.
              </p>
            </div>
            <div className="bg-black/50 p-5 sm:p-6 lg:p-8 rounded-xl border-l-4 border-primary backdrop-blur">
              <h3 className="text-primary text-xl sm:text-2xl mb-2 font-semibold">⭐ Our Values</h3>
              <p className="text-foreground/70 text-sm sm:text-base">
                Excellence, Innovation, Integrity, and Student Success drive everything we do.
              </p>
            </div>
            <div className="bg-black/50 p-5 sm:p-6 lg:p-8 rounded-xl border-l-4 border-primary backdrop-blur">
              <h3 className="text-primary text-xl sm:text-2xl mb-2 font-semibold">✅ MSME Certified</h3>
              <p className="text-foreground/70 text-sm sm:text-base">
